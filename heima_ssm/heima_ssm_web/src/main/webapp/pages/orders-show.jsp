				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								<td>
									<input type="text" size="5" value="${traveller.travellerTypeStr}" readonly="readonly">
								</td>
								<td>
									<input type="text" size="5" value="${traveller.name}" readonly="readonly">
								</td>
								<td>
									<input type="text" size="5" value="${traveller.sex}" readonly="readonly">
								</td>
								<td>
									<input type="text" size="10" value="${traveller.phoneNum}" readonly="readonly">
								</td>
								<td>
									<input type="text" size="5" value="${traveller.credentialsTypeStr}" readonly="readonly">
								</td>
								<td>
									<input type="text" size="15" value="${traveller.credentialsNum }" readonly="readonly">
								</td>
							</tr>
						</c:forEach>
